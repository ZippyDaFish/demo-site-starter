<h1 class="text-4xl font-bold mb-4">Welcome to Small Manufacturing Co.</h1>
<p class="text-lg text-gray-700">
We provide precision‑crafted components for a wide range of industries.
Our commitment to quality and efficiency makes us a trusted partner.
</p>
...
<div class="mt-10 p-6 bg-gray-100 rounded-lg shadow-lg">
    ...
    <a href="$app/contact" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block mt-auto">Request a Quote</a>
    </div>
    ...
    <a href="$app/about" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block mt-auto">Learn More</a>
    </div>
    ...
    <a href="$app/contact" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block mt-auto">Start a Project</a>
    </div>
    ...
    <a href="$app/contact" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block mt-auto">Get a Quote</a>
    </div>
    ...
    <a href="$app/contact" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block mt-auto">Schedule Inspection</a>
    </div>
    </div>
</div>